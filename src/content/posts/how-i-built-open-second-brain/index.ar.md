...
## من سير العمل اليدوي إلى Dark Factory
...
أردت الوصول إلى نموذج أكثر صرامة، والذي يبدو بشكل متزايد مثل Dark Factory: على المدخل فكرة ميزة، وعلى المخرج — الميزة محققة ومختبرة ومنشورة. ليس "الوكيل كتب قطعة كود"، بل مصنع قادر على تقسيم العمل إلى مراحل بنفسه وقيادته عبر العملية.

لا يزال الوصول إلى Dark Factory الكاملة بعيدًا. لكن الخطوة العملية الأولى موجودة بالفعل: Hermes، مرفوع على VPS، مع وكلاء لمهام مختلفة، ومهارات، وواجهة Telegram، وتوجيه رخيص للنماذج عبر OmniRoute.
...
هذا لا يزال ليس Dark Factory. لكنه لم يعد مجرد "محادثة مع نموذج".
...
- تحويل سير العمل الحالي إلى Dark Factory أكثر استقلالية؛
