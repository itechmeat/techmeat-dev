...
## ম্যানুয়াল ওয়ার্কফ্লো থেকে Dark Factory পর্যন্ত
...
আমি একটি আরও কঠোর মডেলে পৌঁছাতে চেয়েছি, যা ক্রমশই Dark Factory নামে পরিচিত হচ্ছে: ইনপুটে একটি ফিচারের ধারণা, আউটপুটে ফিচার বাস্তবায়িত, পরীক্ষিত এবং ডিপ্লয় করা। "এজেন্ট কোডের একটি অংশ লিখেছে" নয়, বরং একটি ফ্যাক্টরি যা নিজে কাজকে পর্যায়ে ভাগ করতে পারে এবং প্রক্রিয়ার মধ্য দিয়ে পরিচালনা করতে পারে।

সম্পূর্ণ Dark Factory এখনও অনেক দূরে। কিন্তু প্রথম ব্যবহারিক পদক্ষেপ ইতিমধ্যে নেওয়া হয়েছে: VPS-এ চলমান Hermes, বিভিন্ন কাজের জন্য এজেন্ট, স্কিল, Telegram ইন্টারফেস এবং OmniRoute এর মাধ্যমে সস্তা মডেল রাউটিং সহ।
...
এটি এখনও Dark Factory নয়। কিন্তু এটি আর শুধু "মডেলের সাথে চ্যাট"ও নয়।
...
- বর্তমান ওয়ার্কফ্লোকে আরও স্বায়ত্তশাসিত Dark Factory-এ রূপান্তর করতে;
