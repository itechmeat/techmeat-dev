...
prFileId: b100ab675be563c43fd7ae534a20aa23a0b33b4e327d7645d9566bec6e4a46f4
---
...
By the way, [here's exactly what a real receipt looks like](/files/fal-generate-a-no-text-fast-sdxl-illustration-for-the-techmeat-d.md) - the one for the very illustration at the top of this post. Raw Markdown straight out of the vault, with no processing. Frontmatter with all the fields listed above, and below it a human-language note about "why", "what the policy returned", and "how much was actually debited".

Inside the Second Brain it lives at this path:
...
No magic: date → folder, slug → filename. Comfortable for grep, git diff, and ordinary navigation in Obsidian.
