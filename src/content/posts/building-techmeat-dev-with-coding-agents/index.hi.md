...
मैंने डिज़ाइन को जान-बूझकर एक अलग फ़ेज़ के तौर पर रखा — ताकि उसे आर्किटेक्चर और कंटेंट के साथ एक ही टास्क में न मिलाऊँ। साथियों ने [Impeccable](https://impeccable.style/) skill सिस्टम की सिफ़ारिश की — यह डिफ़ॉल्ट AI सौंदर्य के बजाय एजेंट को ज़्यादा सोच-समझकर एक विज़ुअल बनाने में मदद करता है।
...
आगे — पोस्टर, ताकि सोशल नेटवर्क पर ब्लॉग के लिंक शेयर होने पर अच्छे दिखें। मैंने [Pencil](https://www.pencil.dev/) जोड़ा (उनका MCP बहुत बढ़िया है) और Claude Code से कहा कि एक [पोस्टर सिस्टम](https://github.com/itechmeat/techmeat-dev/blob/master/design/posters.pen) बनाए और प्रोजेक्ट में एक्सपोर्ट करे। थोड़े मैन्युअल टच-अप ज़रूरी हुए, लेकिन कुल मिलाकर — तेज़ और साफ़।
